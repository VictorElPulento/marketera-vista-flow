  ...
  return (
    <section className="py-20 container mx-auto container-padding">
      <div className="flex flex-col md:flex-row justify-between items-center mb-12">
        <h2 className="text-3xl md:text-4xl font-bold text-marketera-blue-dark">Featured Product</h2>
        ...
        <div className="p-6">
          ...
          <div className="mt-6 space-y-4">
            <p className="text-marketera-gray-dark">
              The EraSound Pro is our most advanced smart speaker yet, featuring AI-powered voice recognition, 
              360° spatial audio, and seamless integration with your smart home ecosystem.
            </p>
            
            <div className="grid grid-cols-2 gap-4 mt-6">
              <div className="flex items-center gap-2">
                <div className="h-3 w-3 rounded-full bg-marketera-neon-lime"></div>
                <p className="text-sm text-marketera-gray-dark">360° Spatial Audio</p>
              </div>
              <div className="flex items-center gap-2">
                <div className="h-3 w-3 rounded-full bg-marketera-neon-lime"></div>
                <p className="text-sm text-marketera-gray-dark">Advanced Voice Recognition</p>
              </div>
              <div className="flex items-center gap-2">
                <div className="h-3 w-3 rounded-full bg-marketera-neon-lime"></div>
                <p className="text-sm text-marketera-gray-dark">Smart Home Integration</p>
              </div>
              <div className="flex items-center gap-2">
                <div className="h-3 w-3 rounded-full bg-marketera-neon-lime"></div>
                <p className="text-sm text-marketera-gray-dark">24hr Battery Life</p>
              </div>
            </div>
